// Compi`le by either typing 'make' in the terminal 
...
int main(){
    ...
    // TODO: Add 50 more artists 
        ...
        artist_t* moreArtists = malloc(sizeof(artist_t));
        for(int i =0; i < rookieArtists; ++i){
          ...
          moreArtists_tid[i] = i;
          pthread_create(&moreArtists_tid[i],NULL,(void*)paint,moreArtists);
