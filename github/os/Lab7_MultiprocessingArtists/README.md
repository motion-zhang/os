...
- Run:  `cat /proc/cpuinfo | grep "cpu cores"` 
  - The first part (before the pipe) gives all of the technical specs for our server machines.
...
- Unix users should be in luck, an X11 window is running. Just ssh with '-Y'.
